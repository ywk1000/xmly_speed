                    ...
                    if (temptest) {
                        if (temptest.status == 0) {
                            ...
                            if (!isLogin) {
                                ...
                                if (MessageUserGp10) {
                                    userIndex10 = MessageUserGp10.findIndex((item) => item === strPtPin);
                                }
                                if (MessageUserGp2) {
                                ...
                                if (MessageUserGp8) {
                                    userIndex8 = MessageUserGp8.findIndex((item) => item === strPtPin);
                                }
                                if (MessageUserGp9) {
                                    userIndex9 = MessageUserGp9.findIndex((item) => item === strPtPin);
                                }
                                ...
                                if (userIndex9 != -1) {
                                    console.log(`该账号属于分组9`);
                                    text = "京东CK检测#9";
                                }
                                if (userIndex10 != -1) {
                                    console.log(`该账号属于分组10`);
                                    text = "京东CK检测#10";
                                }
                ...
                for (let i = 0; i < envs.length; i++) {
                    ...
                    if ($.Remark) {
                        ...
                        try {
                            ...
                            if (text == "京东资产统计" || text == "京东资产统计#2" || text == "京东资产统计#3" || text == "京东资产统计#4" || text == "京东资产统计#5" || text == "京东资产统计#6" || text == "京东资产统计#7" || text == "京东资产统计#8" || text == "京东资产统计#9" || text == "京东资产统计#10") {
                                var Tempinfo = "";
                                if (envs[i].created)
