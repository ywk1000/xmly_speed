...
!(async () => {
    ...
    if (intPerSent > 0) {
        ...
        if ($.isNode() && allMessageMonthGp5) {
            await notify.sendNotify(`京东月资产统计#5`, `${allMessageMonthGp5}`, {
                url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
            })
            await $.wait(10 * 1000);
        }
        if ($.isNode() && allMessageMonthGp6) {
            await notify.sendNotify(`京东月资产统计#6`, `${allMessageMonthGp6}`, {
                url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
            })
            await $.wait(10 * 1000);
        }
        if ($.isNode() && allMessageMonthGp7) {
            await notify.sendNotify(`京东月资产统计#7`, `${allMessageMonthGp7}`, {
                url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
            })
            await $.wait(10 * 1000);
        }
        if ($.isNode() && allMessageMonthGp8) {
            await notify.sendNotify(`京东月资产统计#8`, `${allMessageMonthGp8}`, {
                url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
            })
            await $.wait(10 * 1000);
        }
    ...
    if ($.isNode() && allMessage2Gp5) {
        ...
        await notify.sendNotify("京东白嫖提醒#5", `${allMessage2Gp5}`, {
            url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
        })
        await $.wait(10 * 1000);
    }
    if ($.isNode() && allMessage2Gp6) {
        ...
        await notify.sendNotify("京东白嫖提醒#6", `${allMessage2Gp6}`, {
            url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
        })
        await $.wait(10 * 1000);
    }
    if ($.isNode() && allMessage2Gp7) {
        ...
        await notify.sendNotify("京东白嫖提醒#7", `${allMessage2Gp7}`, {
            url: `https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean`
        })
        await $.wait(10 * 1000);
    }
    ...
    if ($.JdFarmProdName != "") {
        if ($.JdtreeEnergy != 0) {
            if ($.treeState === 2 || $.treeState === 3) {
				...
				if (userIndex5 != -1) {
					ReceiveMessageGp5 += `【账号${IndexGp5} ${$.nickName || $.UserName}】${$.JdFarmProdName} (老农场)\n`;
				}
				if (userIndex6 != -1) {
					ReceiveMessageGp6 += `【账号${IndexGp6} ${$.nickName || $.UserName}】${$.JdFarmProdName} (老农场)\n`;
				}
				if (userIndex7 != -1) {
					ReceiveMessageGp7 += `【账号${IndexGp7} ${$.nickName || $.UserName}】${$.JdFarmProdName} (老农场)\n`;
				}
				if (userIndex8 != -1) {
					ReceiveMessageGp8 += `【账号${IndexGp8} ${$.nickName || $.UserName}】${$.JdFarmProdName} (老农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1 && userIndex5 == -1 && userIndex6 == -1 && userIndex7 == -1 && userIndex8 == -1) {
            ...
            if ($.treeState === 0) {
				...
				if (userIndex5 != -1) {
					WarnMessageGp5 += `【账号${IndexGp5} ${$.nickName || $.UserName}】水果领取后未重新种植! (老农场)\n`;
				}
				if (userIndex6 != -1) {
					WarnMessageGp6 += `【账号${IndexGp6} ${$.nickName || $.UserName}】水果领取后未重新种植! (老农场)\n`;
				}
				if (userIndex7 != -1) {
					WarnMessageGp7 += `【账号${IndexGp7} ${$.nickName || $.UserName}】水果领取后未重新种植! (老农场)\n`;
				}
				if (userIndex8 != -1) {
					WarnMessageGp8 += `【账号${IndexGp8} ${$.nickName || $.UserName}】水果领取后未重新种植! (老农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1 && userIndex5 == -1 && userIndex6 == -1 && userIndex7 == -1 && userIndex8 == -1) {
				...
				if (userIndex5 != -1) {
					WarnMessageGp5 += `【账号${IndexGp5} ${$.nickName || $.UserName}】状态异常! (老农场)\n`;
				}
				if (userIndex6 != -1) {
					WarnMessageGp6 += `【账号${IndexGp6} ${$.nickName || $.UserName}】状态异常! (老农场)\n`;
				}
				if (userIndex7 != -1) {
					WarnMessageGp7 += `【账号${IndexGp7} ${$.nickName || $.UserName}】状态异常! (老农场)\n`;
				}
				if (userIndex8 != -1) {
					WarnMessageGp8 += `【账号${IndexGp8} ${$.nickName || $.UserName}】状态异常! (老农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1 && userIndex5 == -1 && userIndex6 == -1 && userIndex7 == -1 && userIndex8 == -1) {
